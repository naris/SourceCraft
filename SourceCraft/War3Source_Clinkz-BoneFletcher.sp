...
{
#if defined SOURCECRAFT
	thisRaceID=CreateRace("clinkz", .name="Clinkz-Bone Fletcher", .faction=UndeadScourge, .type=Undead);
#else
	...
	ULT=War3_AddRaceSkill(thisRaceID,"Death Pact","Gain Health from killing targets",true,4); 
		...
		SetUpgradeCooldown(thisRaceID, SKILL_3, 18.0); // Can be altered in the race config file
