...
public OnWar3LoadRaceOrItemOrdered(num)
{
	...
	{
#if defined SOURCECRAFT
		thisRaceID=CreateRace("cd", .faction=Hellbourne, .type=Undead);
#else
		...
		SetUpgradeCooldown(thisRaceID, SKILL_CONDUIT, float(ConduitCooldown));
		SetUpgradeEnergy(thisRaceID, SKILL_CONDUIT, GetUpgradeCooldown(thisRaceID,SKILL_CONDUIT));
		ConduitCooldown = RoundToNearest(GetUpgradeCooldown(thisRaceID,SKILL_CONDUIT));
