...
public bool:InitNativesForwards()
{
	...
	CreateNative("W3SetBuff",Native_War3_SetBuff);//for races
	CreateNative("W3SetBuffItem",Native_War3_SetBuffItem);//foritems
	CreateNative("W3SetBuffItem2",Native_War3_SetBuffItem2);//foritems
#else
...
#if defined SOURCECRAFT
	CreateNative("W_ResetAllBuffRace",NW3ResetAllBuffRace);
	CreateNative("W_ResetBuffRace",NW3ResetBuffRace);
#else
