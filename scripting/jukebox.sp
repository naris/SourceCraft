...
#define help_url "http://www.jigglysfunhouse.net/" // The URL to the Jukebox help guide for your server.  If you don't want to operate your own, a manual for the latest version is kept up to date at http://www.teamcheesus.com/user-manual/jukebox
