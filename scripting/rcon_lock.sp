...
/* These are commands that will have the FCVAR_CHEATS flag added, to prevent execution */
...
/* These are vulnerable Mani commands that will also be disabled */
new String:block_mani[][] = { "timeleft", "nextmap", "ma_timeleft", "ma_nextmap", "listmaps", "ff" };

/* These are cvars that clients are not permitted to have */
