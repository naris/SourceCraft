...
public OnWar3LoadRaceOrItemOrdered(num)
{
	...
	{
#if defined SOURCECRAFT
		thisRaceID=CreateRace("hammerstorm", .faction=TheLegion, .type=Biological);
#else
		...
		SetUpgradeCooldown(thisRaceID, ULT_STRENGTH, 25.0); // Can be altered in the race config file
