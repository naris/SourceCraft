...
public OnWar3LoadRaceOrItemOrdered(num)
{
	if(num==200)
	{
		...
		thisRaceID=CreateRace("dragonborn_o", .faction=TheLegion, .type=Biological);
#else
		...
		SetUpgradeCooldown(thisRaceID, ULTIMATE_DRAGONBREATH, 25.0); // Can be altered in the race config file
